@extends('templates/main',
    [
        'titulo'=>"Sistema GEAS",
        'cabecalho' => 'Nova Fatalidade',
        'rota' => '',
        'relatorio' => '',
    ]
)
@section('conteudo')
    <form action="{{route('deadbirds.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col">
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", function(e) {
        ...
        <div class="row mb-5">
            <div class="col">
                <a href="{{route('deadbirds.index')}}" class="btn btn-secondary btn-block align-content-center">
