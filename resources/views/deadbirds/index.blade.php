@extends('templates/main',
    [
        ...
        'cabecalho' => 'FATALIDADES DE AVES',
        'rota' => 'deadbirds.create',
        'relatorio' => 'report.deadbirds',
            ...
            @foreach ($sightings->where('life_status', 'morto') as $bird)
                <tr>
                    ...
                    <td>
                        ...
                        @can('update', $bird)
                            <a href="{{route('deadbirds.edit', $bird->id)}}" class="btn btn-outline-success">
                        ...
                        @can('delete', $bird)
                            ...
                            <form action="{{route('deadbirds.destroy', $bird->id)}}" method="POST" id="form_{{$bird->id}}">
                                @csrf
                                @method('delete')
                            </form>
                        @endcan
