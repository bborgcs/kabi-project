...
class SightingController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('sightings.create', compact('species'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($species) {
            ...
            if ($request->hasFile('foto')) {
                ...
                $name = 'sighting_'.$sighting->id.'_'.time().'.'.$file->getClientOriginalExtension();

                $file->storeAs('sightings', $name, 'public');

                $image = \App\Models\Image::create([
                    'image_path' => 'sightings/'.$name
                ]);
        ...
        return redirect()->route('sightings.index');
    }
    ...
    public function edit(string $id)
{
    ...
    if ($sighting) {
        $species = Species::all();
        return view('sightings.edit', compact('sighting', 'species'));
    }
  ...
  public function update(Request $request, string $id)
    ...
    {
        $sightings = Sighting::with(['species'])->get();
        $pdf = Pdf::loadView('sightings.report', ['sightings' => $sightings]);
        return $pdf->stream('avistamentos.pdf');
    }
}